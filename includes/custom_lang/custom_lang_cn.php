...
$_LANG['passport_js']['ok'] = '好';
$_LANG['passport_js']['cancel'] = '取消';
$_LANG['passport_js']['fail_send_password'] = '发送邮件出错，请与管理员联系！';
$_LANG['passport_js']['send_success'] = '重置密码的邮件已经发到您的邮箱：';
$_LANG['passport_js']['username_no_email'] = '您填写的用户名与电子邮件地址不匹配，请重新输入！';
$_LANG['passport_js']['no_passwd_question'] = '您没有设置密码提示问题，无法通过这种方式找回密码。';
$_LANG['passport_js']['wrong_passwd_answer'] = '您输入的密码答案是错误的';
$_LANG['passport_js']['password_shorter_than_6'] = '登录密码不能少于 6 个字符。';
...
$_LANG['label_collection_user'] = '我的收藏';
...
$_LANG['edit_password_failure_due_time'] = '设置新密码失败，可能由于您的长时间未操作，请重新再试一次。';
...
$_LANG['password_js']['ok'] = '好';
$_LANG['password_js']['cancel'] = '取消';
