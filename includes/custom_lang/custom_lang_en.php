...
$_LANG['passport_js']['ok'] = 'Ok';
$_LANG['passport_js']['cancel'] = 'Cancel';
$_LANG['passport_js']['fail_send_password'] = 'There is something wrong with email sending';
$_LANG['passport_js']['send_success'] = 'New password successfully sent to your email';
$_LANG['passport_js']['username_no_email'] = 'The username and email address do not match, please try again!';
$_LANG['passport_js']['no_passwd_question'] = 'You have not set secure question';
$_LANG['passport_js']['wrong_passwd_answer'] = 'The answer is wrong';
$_LANG['passport_js']['password_shorter_than_6'] = 'Password cannot less than 6 characters';

/* 用户菜单 */
$_LANG['label_welcome'] = 'Welcome';
$_LANG['label_profile'] = 'Profile';
$_LANG['label_order'] = 'Order';
$_LANG['label_address'] = 'Address';
$_LANG['label_message'] = 'Message';
$_LANG['label_tag'] = 'Tag';
$_LANG['label_collection_user'] = 'Wish list';
$_LANG['label_bonus'] = 'Bonus';
$_LANG['label_comment'] = 'Comment';
$_LANG['label_affiliate'] = 'Recommend';
$_LANG['label_group_buy'] = 'Group buy';
$_LANG['label_booking'] = 'Booking';
$_LANG['label_user_surplus'] = 'Funds Management';
$_LANG['label_track_packages'] = 'Track';
$_LANG['label_transform_points'] = 'Points transfer';
...
$_LANG['rank_integral'] = 'Rank point';
$_LANG['consume_integral'] = 'Consume point';
$_LANG['account_balance'] = 'Account balance';
$_LANG['user_bonus'] = 'Bonus';
$_LANG['user_bonus_info'] = 'Total %d, worth %s';
$_LANG['not_bonus'] = 'No bonus';
$_LANG['add_user_bonus'] = 'Add a bobus';
$_LANG['bonus_number'] = 'Bonus number';
...
$_LANG['input_answer'] = 'Please enter the answer to your secure question that you chose when you registered';
$_LANG['wrong_passwd_answer'] = 'The answer is wrong';
$_LANG['enter_new_password'] = 'Please enter your new password';
$_LANG['parm_error'] = 'Parameter error';
$_LANG['edit_password_failure'] = 'The old password is incorrect';
$_LANG['edit_password_failure_due_time'] = 'The password is not reset maybe due to the session expiration， please try again';
$_LANG['edit_password_success'] = 'Your new password has been set up successfully';
$_LANG['username_not_match_email'] = 'The username and email address do not match';
$_LANG['no_passwd_question'] = 'You have not set secure question';

$_LANG['get_question_username'] = 'Please enter your username to get you secure question.';
$_LANG['username_and_email'] = 'Please enter your username and email address.';
$_LANG['back_page_up'] = 'Back';
...
$_LANG['password_js']['email_address_error'] = 'The email address format is invalid!';
$_LANG['password_js']['new_password_empty'] = 'Please enter your new password!';
$_LANG['password_js']['confirm_password_empty'] = 'Please confirm your password!';
$_LANG['password_js']['both_password_error'] = 'The passwords do not match!';

$_LANG['password_js']['ok'] = 'Ok';
$_LANG['password_js']['cancel'] = 'Cancel';
...
$_LANG['login_success'] = 'You have successfully logged in';
$_LANG['confirm_login'] = 'Confirm to login';
$_LANG['profile_lnk'] = 'View my profile';
$_LANG['login_failure'] = 'Username or password wrong';
